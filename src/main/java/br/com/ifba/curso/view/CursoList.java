 ...
 */
@Component
public class CursoList extends javax.swing.JFrame implements ApplicationContextAware{
    ...
    private ApplicationContext applicationContext; // 2. VARIÁVEL PARA O CONTEXTO SPRING
     ...
     */
    @Autowired
    public CursoList(CursoIController cursoController) {
        // inicializa o controller como parametro recebido
        this.cursoController = cursoController;
        
        initComponents();
        carregarDados(); // carrega os dados na tabela
        // 1. Define um tamanho fixo 
        this.setSize(800, 400); 

        // 2. Impede que o usuário redimensione a janela
    ...
    // MÉTODO QUE O SPRING USARÁ PARA LHE DAR O CONTEXTO
    @Override
                    ...
                    // AÇÃO DE REMOVER
                        ...
                        if (resposta == JOptionPane.YES_NO_OPTION) {
                            try {
                                ...
                                JOptionPane.showMessageDialog(CursoList.this, "Curso removido com sucesso!");
                                ...
                                JOptionPane.showMessageDialog(CursoList.this, "Erro ao remover curso: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                                e.printStackTrace();
                            }
                        }
                    }
